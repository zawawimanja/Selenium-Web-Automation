...
public class Velocity extends Base {
	...
	@Test
	public void Card_CreateVelocity() throws InterruptedException {
		...
		velocityPage.setExpDate("0324");
		velocityPage.clickSubmit();
	...
	@Test(priority = 1)
	public void Card_DeleteVelocity() throws InterruptedException {
		velocityPage = new VelocityPage(driver);
